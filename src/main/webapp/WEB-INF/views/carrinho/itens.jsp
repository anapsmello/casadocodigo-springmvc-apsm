...
<jsp:attribute name="extraScripts">
	<script> console.log("Finalização da compra de ${carrinhoCompras.quantidade} itens."); </script>
</jsp:attribute>
		  ...
		  <h2 id="cart-title">Seu carrinho de compras</h2>
		    ...
		    <table id="cart-table">
			  ...
			  <tfoot>
			        <tr>
			          <td colspan="3">
			          <form:form action="${pageContext.request.contextPath}/pagamento/finalizar" method="post">
